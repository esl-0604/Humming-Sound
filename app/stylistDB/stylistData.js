...
export const stylistDB = {
  jenfloxStylist: {
    ...
    avgGrade: "5.0",
    consultingAmount: "3",
    styleTags: ["깔끔함", "무난함", "꾸안꾸", "은은한 개성 한방울", "남친룩"],
    aboutMe: [
    ...
    forWho: [
      "호불호가 가장 적고 대중의 픽이 되는 스타일로 입고 싶으신 분",
      "여성분들이 ‘깔끔하다’고 일컫는 스타일을 본인에게 맞게 연출하고 싶으신 분들",
      "깔끔한 기본 스타일 + 개성을 한스푼으로 은은하고 과하지 않는 룩을 원하시는 분들",
      "어떻게 입어서야 할 지 감이 안오시는 대학생분들",
      "어떻게 입어서야 할 지 어려움을 겪고 계신 직장인분들",
      "패션에 이제 막 입문하셔서 아무것도 모르겠는 패린이분들",
    ],
    phillosophy: [
      "저는 여러분의 목적에 따른 니즈, 그리고 그에 대한 해소로서 스타일링 서비스를 진행합니다. 그리고 저는 이미 많은 데이터들을 통해 짧은 상담만으로도 여러분의 현재상태와 니즈를 명확하고 빠르게 캐치할 수 있고, 그에 대한 해답을 즉시 제시해드릴 수 있습니다.",
      "",
      "저는 여러분의 필요에 제가 권장드리는 사항들을 알맞게 절충시킨 내용으로 상담해드리기 때문에, 여러분들이 ‘옷차림’에 있어서 느끼셨던 모든 고민들과 어려움들을 명쾌하게 해소하실 수 있고, 저 또한 그것을 목적으로 책임감있게 임할 것 입니다.",
      "",
      "아무것도 모르신다고 해도 문제 없습니다. ",
      "그저 제가 정해드리는 대로 하시면 됩니다.",
    ],
  ...
  josknStylist: {
    ...
    name: "승관",
    comment: "all style all trend 모든 스타일 모든 트렌드",
    instagramId: "joskn_",
    avgGrade: "5.0",
    consultingAmount: "8",
    styleTags: ["all style", "all trend", "모든"],
    aboutMe: ["개인 스타일리스트, 퍼스널쇼퍼 경력 5년차"],
    forWho: [
      "이제 막 패션에 관심을 가지기 시작하신 분",
      "아무것도 모르니 그냥 어울리는걸 찾고 싶으신 분",
      "특별한 이벤트, 특별한 날에 필요한 스타일링이 필요하신 분",
      "나에게 잘맞는 세련된 이미지가 필요하신 분",
      "가장트랜디한 스타일을 하고 싶으신 분",
      "이성에게 어필하고 싶은 스타일을 원하시는 분",
      "본인의 고집과 본인의 취향을 내려놓으실 수 있으신 분",
    ],
    phillosophy: [
      "오늘이 가장 젊은날인데 그냥 후줄근하게만 보내기엔 너무 아깝지 않나요?",
      "",
      "요즘 스타일 좋은사람 많아졌죠. 그만큼 이미지가 중요한 때입니다. 당연히 외적인 모습만이 중요한건 아니지만 외면이 갖춰져있지 않다면 어쩌면 내면이 보여질 기회를 얻지 못할수도 있습니다. 그리고 내면이 갖춰진 분들은 또 대게 외적으로도 자신만의 스타일이 있으시더라구요.",
      "",
      "스타일이란건 옷 뿐만아니라 헤어, 메이크업부터 마인드, 자세, 표정, 행동 모든게 어우러질 때 스타일이 산답니다. 스타일이란게 꼭 비싸고 화려하고 트랜디하게만 입어야 맞는게 아닙니다. 자신이 무엇을 원하는지 사람들에게 보이는 이미지가 먼저인지, 내 만족이 먼지인지 그것부터 정해야 합니다. 그 어떤 스타일이라도 자신이 그걸 받아들일 마음가짐이 되있지 않거나 내 상황에 TPO에 맞지 않는 스타일이라면 아무리 잘 입어도 헛게 되는것이죠. 이미지, 상황, 니즈 등에 맞는 스타일링을 해드립니다.",
    ],
    ...
    reviewList: [
      {
        ...
        grade: "5.0",
        comment:
          "제가 원하는 스타일을 잘 캐치해주시고 제 체형에 맞게 스타일링해주세요 감사합니다!",
        imageList: [],
      },
      {
        reviewer: "천**",
        ...
        grade: "5.0",
        comment:
          "너무 흥미로웠어요 잘 어울리는 옷들을 알게되고 구매하게 되어 행복합니다. 자기한테 잘 맞는 착장이 뭔지 모를 때 부탁드리면 딱 좋아요ㅎㅎ",
        imageList: [],
      },
      {
        reviewer: "홍**",
        ...
        grade: "5.0",
        comment:
          "계절마다 스타일리스트님께 스타일컨설팅 받고 있는데 너무 좋아요 물론 이번계절도 대만족이구요:) 적절히 트랜드와 제 이미지랑 스타일 반영해서 해주셔서 오래도록 입을수 있는것들로 해주셔서 옷들이나 다른아이템들도 너무 잘입고있 세련되게 컨설팅 해주셔서 너무 만족입니다!",
        imageList: [],
      },
      {
        reviewer: "김**",
        ...
        grade: "5.0",
        comment:
          "지루하고 지쳐있던 일상에 기분전환이 되는 시간이었어요. 제가 원하는 스타일링은 물론 체형과 키에 맞는 패션 팁도 알려주시니 좋더라고요. 오프라인에서 추천해주신 착장도 제가 평소라면 피팅룸에 가져가지 않았을 스타일인데 이렇게 잘 어울려서 너무 재미있고 자신감이 생기더라고요. 누군가에게 진심을 다해 케어받는 기분이 들어 더 좋은 시간이었어요! 온라인 스타일링도 부탁드린 상태인데 너무 기대돼요.",
        imageList: [],
      },
      {
        reviewer: "홍**",
        ...
        grade: "5.0",
        comment:
          "젊은분이라 트랜디한 감각으로 센스있게 잘해주시네요!! 완전만족합니다!! 제 이미지와 체형에 맞게 스타일링 해주시고 궁금한것들은 친절히 답해주셔서 더 만족해요!!",
        imageList: [],
      },
      {
        reviewer: "다**",
        ...
        grade: "5.0",
        comment:
          "정말 친절하시고 계절마다 옷트렌드에 대해 너무 잘알려주셔서 감사합니 다. 이제 봄이여서 옷고민이 많았는데 코로나로 마음과기분이 지쳤었는데, 새로운옷보면서 많이 힐링되고 적극 추천드려요!",
        imageList: [],
      },
      {
        reviewer: "김**",
        ...
        grade: "5.0",
        comment:
          "너무 나에게 맞게 옷도 잘 골라주시고 무엇보다 제 단점을 보완해주고 더 날씬하고 예쁘게 도와주셨어요!! 진짜 머리부터 발끝까지 너무 만족스럽고 내가 이렇게 예뻐질수 있구나 자신감, 자존감도 상승했어요ㅎㅎ 다음에 꼭 다시 찾을게요!!",
        imageList: [],
      },
      {
        reviewer: "장**",
        ...
        grade: "5.0",
        comment:
          "상담은 저(30대 중반)와 어머니(60대 초반) 함께 진행 했고, 갖고 있는 옷을 세련되게 연출할 수 있는 부분을 짚어주셔서 도움이 되었습니다. 쇼핑동행 동안 차분하게 제 이미지에 맞는 옷+제가 그동안 선입견으로 시도해 보지 않은 옷들을 추천해주셨습다. 무엇보다 그동안 20-30대 고객분들을 많이 컨설팅 해주셔서 그런지 제 나이에 맞는 옷을 추천해 주셔서 좋았습니다. 너무 중후한 느낌으로 빠지지 않게 세련미/여성미 날 수 있는 옷들을 제가 원하는 가격대로 잘 짚어 주셨어요~ 다음 쇼핑시에 또 뵙겠습니다!",
        imageList: [],
      },
    ],
    contentsList: [],
